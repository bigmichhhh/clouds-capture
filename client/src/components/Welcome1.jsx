  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex lg:flex-row flex-col items-start justify-between lg:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10 order-2">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full lg:mt-0 mt-10 order-1">
