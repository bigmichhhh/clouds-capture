...
const NavBarItem = ({ title, classprops }) => (
  <li className={`mx-4 hover:text-sky-400 cursor-pointer ${classprops}`}>{title}</li>
);
...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-slate-800 border-b border-slate-600 flex md:justify-center justify-between items-center p-4">
      ...
      <div className="flex relative">
        ...
        {toggleMenu && (
          ...
          >
            ...
            {["v2", "Exchange", "Market", "Wallets"].map(
